...
const Footer = () => {
  ...
  // Special pages that should have minimal or no footer
  const isAuthVerifyPage = pathname.includes('/auth/verify');
  const isError404Page = pathname === '/404' || pathname.includes('not-found');
  const isAuthPage = pathname.startsWith('/auth/');
  
  // For error pages, show minimal footer
  if (isError404Page) {
    return (
